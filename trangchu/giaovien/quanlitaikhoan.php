            ...
            <div class="card" id="style-7" style="overflow-y: auto;">
                <div class="card-body" style="height: 74vh; text-align: left;">
                    <div style="margin: 20px 20px 20px 20px">
                        ...
                        ?>
                        <b>Tên: </b> <?php echo htmlspecialchars($user['name']) ?>&nbsp<input id="change_name" class="btn btn-secondary font-weight-bold" type="submit" style="width: 7rem;border-radius: 10px;height: 2.2rem;font-family: Quicksand, sans-serif;background: #ff7551;border: none;" value ="Đổi tên"><br>
