                        ...
                        <div class="card">
                            <div class="card-body text-danger" style="font-family: Montserrat, sans-serif;">
                                <form method="POST">
                                    ...
                                    ?>
                                    <h4 class="card-title"><?php echo $val==1?"Giáo viên":"Học sinh" ?> đăng nhập</h4>
                                    <h6 class="text-danger card-subtitle mb-md-4 mb-3" style="font-size: 13px;color: rgb(225,88,101)!important;">Sử dụng tài khoản của HA TEST để đăng nhập</h6><input name="username" type="text" class="input-login mb-3" placeholder="Tài khoản" required><input name="password" type="password" class="input-login mb-md-2 mb-3" placeholder="Mật khẩu" required><input class="btn btn-primary mb-4"
                                        type="submit" name="login" style="border-radius:50px;background: #FFAFBD;  /* fallback for old browsers */ background: -webkit-linear-gradient(to right, #ffc3a0, #FFAFBD);  /* Chrome 10-25, Safari 5.1-6 */ background: linear-gradient(to right, #ffc3a0, #FFAFBD); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */border:none;" value="Đăng Nhập">
                                    <p
                                        style="margin-bottom:0;">Nếu bạn chưa có tài khoản, đăng kí&nbsp;<strong class="text-danger"><a class="text-danger kgach" <?php echo 'href="../register/index.php?val='.$val.'"'?></a>tại đây</a></strong></p>
                                        <p>Nếu bạn chưa có tài khoản quên mật khẩu, khôi phục&nbsp;<strong class="text-danger"><a class="text-danger kgach" href="../recovery.php">tại đây</a></strong></p>
                                </form>
